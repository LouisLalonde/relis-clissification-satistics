 ...
 * @generated
 */
public abstract class StatisticImpl extends EObjectImpl implements Statistic {
	/**
	...
	protected EClass eStaticClass() {
		return RelisPackage.Literals.STATISTIC;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelisPackage.STATISTIC__NAME, oldName, name));
	}
