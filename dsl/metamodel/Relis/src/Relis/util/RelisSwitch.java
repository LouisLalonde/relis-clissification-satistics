 ...
 * @generated
 */
public class RelisSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static RelisPackage modelPackage;
	...
	public RelisSwitch() {
		if (modelPackage == null) {
			modelPackage = RelisPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RelisPackage.RELIS_ROOT: {
				RelisRoot relisRoot = (RelisRoot)theEObject;
				T result = caseRelisRoot(relisRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelisPackage.STATISTIC: {
			...
			case RelisPackage.DESCRIPTIVE: {
				...
				if (result == null) result = caseStatistic(descriptive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelisPackage.COMPARATIVE: {
				...
				if (result == null) result = caseStatistic(comparative);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelisPackage.EVOLUTION: {
				...
				if (result == null) result = caseStatistic(evolution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseRelisRoot(RelisRoot object) {
		return null;
	}
